...
const dataByPeriod = {
  'Día': {
    ...
    viajesSub: 'hoy',
    bars: [
      { day: '07:00', amount: 280, max: 840 },
      { day: '12:00', amount: 280, max: 840 },
      { day: '18:00', amount: 280, max: 840 },
    ],
  },
  'Semana': {
    label: 'Gastado esta semana',
    total: '$4.060',
    change: '12% más que semana anterior',
    changeIcon: 'trending-up-outline',
    changeColor: '#F87171',
    promedio: '$580',
    promedioSub: 'por día',
    ...
    bars: [
      { day: 'Lun', amount: 840, max: 1120 },
      { day: 'Mar', amount: 560, max: 1120 },
      { day: 'Mié', amount: 1120, max: 1120 },
      { day: 'Jue', amount: 700, max: 1120 },
      { day: 'Vie', amount: 560, max: 1120 },
      { day: 'Sáb', amount: 280, max: 1120 },
      { day: 'Dom', amount: 0, max: 1120 },
    ],
  },
  'Mes': {
    label: 'Gastado en junio',
    total: '$7.280',
    change: '8% menos que mayo',
    changeIcon: 'trending-down-outline',
    changeColor: '#34D399',
    promedio: '$933',
    promedioSub: '~3,3 viajes',
    viajes: '26',
    viajesSub: 'este mes',
    bars: [
      { day: 'S1', amount: 1960, max: 2800 },
      { day: 'S2', amount: 2800, max: 2800 },
      { day: 'S3', amount: 1400, max: 2800 },
      { day: 'S4', amount: 1120, max: 2800 },
    ],
  },
  'Año': {
    label: 'Gastado en 2026',
    total: '$38.640',
    change: '5% menos que 2025',
    changeIcon: 'trending-down-outline',
    changeColor: '#34D399',
    promedio: '$7.728',
    promedioSub: 'por mes',
    ...
    viajesSub: 'este año',
    bars: [
      { day: 'Ene', amount: 6720, max: 8400 },
      { day: 'Feb', amount: 5880, max: 8400 },
      { day: 'Mar', amount: 8400, max: 8400 },
      { day: 'Abr', amount: 7560, max: 8400 },
      { day: 'May', amount: 7920, max: 8400 },
      { day: 'Jun', amount: 2160, max: 8400 },
    ],
  },
};
